Contributing to Believe Core
==================================

The Believe Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Believe Core project, and is not to be
confused with overall Believe Network Protocol consensus changes.

Whether a pull request is merged into Believe Core rests with the project merge
...
Patches that change Believe consensus rules are considerably more involved than
...
Where a patch set proposes to change the Believe consensus, it must have been
...
The project leader is the release manager for each Believe Core release.
