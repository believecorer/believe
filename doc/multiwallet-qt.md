...
In order to support loading of multiple wallets in believe-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is believe.cpp.
...
Changes to believe.cpp
----------------------
believe.cpp is the entry point into believe-qt, and as such, will require some minor modifications to provide hooks for
