...
#   c) node1 mines 32 blocks, so now node 0 has 500000BLE, node 1 has 4250BLE, node2 has none.
#   d) node0 sends 601 BLE to node2, in two transactions (301 BLE, then 300 BLE).
